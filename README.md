...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dask-mongo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13507&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dask-mongo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dask-mongo` can be installed with:

```
conda install dask-mongo
```

It is possible to list all of the versions of `dask-mongo` available on your platform with:
